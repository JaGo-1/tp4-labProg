...
public class Alta_materias extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        guardar_btn.setBackground(new java.awt.Color(133, 189, 252));
        ...
        jSeparator3.setForeground(new java.awt.Color(133, 189, 252));
        jSeparator3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N

        jSeparator2.setForeground(new java.awt.Color(133, 189, 252));
        ...
        jLabel5.setText("Complete los siguientes datos para ingresar una materia.");
